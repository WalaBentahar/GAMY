<?php
require_once '../../config.php'; // Include the config class for database connection
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        $isAdded = $userModel->addUser($nom, $prenom, $email, $phone, $pays, $password);
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="input-single">
                                ...
                                <input name="phone" id="phone" placeholder="phone" class="gaming-input">
                                <div class="input-highlight"></div>
                            </div>
                        </div>
                        <div class="col-lg-12">
