...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($enteredCode)) {
        ...
        if (isset($_SESSION['reset_code']) && $_SESSION['reset_code'] == $enteredCode) {
...
<head>
    ...
    <title>Verify Code - Gaming Portal</title>
    ...
    <div class="verify-container">
        ...
        <form method="POST">
            <div class="form-group">
                <label for="reset_code" class="form-label">ENTER THE VERIFICATION CODE</label>
                <input type="text" id="reset_code" name="reset_code" class="game-input" placeholder="XXXXXX" required>
        ...
        <div class="form-footer">
            ...
            <a href="reset.php">Resend Code</a>
        </div>
    </div>
</body>
</html>
