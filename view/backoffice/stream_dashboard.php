...
<head>
    ...
    <title>GAMY | Admin Dashboard - Videos</title>
        ...
        <div class="container-fluid py-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admin Panel - Videos</h3>
                </div>
                <div class="card-body">
                    <!-- Add Video Form -->
                    <form method="POST" action="" class="mb-4">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="video_url" name="video_url" class="form-control" placeholder="Enter YouTube URL" required>
                            </div>
                            <div class="col-md-4">
