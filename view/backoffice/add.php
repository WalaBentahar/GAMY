...
<head>
    ...
    <title>GAMY | Admin - Add Stream</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            z-index: 1000;
            transition: all 0.3s cubic-bezier(0.4, 0, 0.-Aid2, 1);
        ...
        <div class="container-fluid py-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add New Stream</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <label for="stream_input" class="form-label">YouTube Stream</label>
                                <input type="text" id="stream_input" name="stream_input" class="form-control" 
                                       placeholder="URL or ID" required 
